 ...
 * --------------------------------------------------------
 * The OLD_ClientHandler class handles each individual client connection as a thread.
 * It implements the Runnable interface.
 * 
 * The class includes the following methods:
 * @constructor OLD_ClientHandler : Specify connection details (socket, secret word and connection ID).
 ...
 */
public class OLD_ClientHandler implements Runnable {
    private final Socket CLIENT_SOCKET;
    private final String SECRET_WORD;
    private final int CONNECTION_ID;

    public OLD_ClientHandler(Socket clienSocket, String secretWord, int connectionID) {
