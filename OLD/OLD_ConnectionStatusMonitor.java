 ...
 * --------------------------------------------------------
 * The OLD_ConnectionStatusMonitor class acts as a tuple (x,y) for identifying 
 ...
 * @constructor OLD_ConnectionStatusMonitor : Specify connection details (thread and connection ID).
 * @method getThread : Return the thread.
 * @method getConnectionID : Return connection ID.
 */

public class OLD_ConnectionStatusMonitor {
    private final Thread THREAD;
    private final int CONNECTION_ID;

    public OLD_ConnectionStatusMonitor(Thread thread, int connectionID) {
        this.THREAD = thread;
